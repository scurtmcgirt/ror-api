...
ITEM_TYPES = {
    ...
    4:"Shield", 5:"Offhand", 6:"Light Armor", 7:"Ranged Weapon", 8:"Accessory",
    9:"Ranged Weapon", 10:"Accessory", 11:"Staff", 12:"Throwing", 13:"Melee Weapon",
    14:"Melee Weapon", 15:"Bag", 16:"Trophy", 17:"Quest Item", 18:"Light Armor",
    19:"Currency", 20:"Heavy Armor", 21:"Dye", 22:"Medium Armor", 23:"Gathering",
...
ITEM_SLOTS = {
    0:"None", 1:"Main Hand", 2:"Off Hand", 3:"Ranged", 4:"Helm", 5:"Shoulder",
    6:"Body", 7:"Gloves", 8:"Waist", 9:"Boots", 10:"Main Hand", 11:"Off Hand",
    12:"Ranged", 13:"Melee", 14:"Melee", 15:"Head", 16:"Shoulder", 17:"Gloves",
    18:"Waist", 19:"Boots", 20:"Body", 21:"Gloves", 22:"Boots", 23:"Gloves",
    24:"Jewelry", 25:"Jewelry", 26:"Jewelry", 27:"Jewelry", 28:"Jewelry",
    29:"Pocket", 30:"Pocket", 31:"Trophy", 32:"Pocket", 33:"Pocket", 42:"Bag",
}
...
@app.get("/item_detail", tags=["Items"], summary="Single item detail by entry")
...
def list_items(
    ...
    career:     Optional[int]  = None,       # ← NEW: filter by careerline
    slot_name:  Optional[str]  = None,       # ← NEW: filter by slot_name
):
    params = {
        "select": "entry,name,type,slotid,rarity,minrank,career,slot_name,iconid,model_image",
        "limit":  str(limit),
    ...
    if career    is not None: params["careerline"] = f"eq.{career}"
    if slot_name:             params["slot_name"]  = f"eq.{slot_name}"
